...
function Services() {
    ...
    return (
    <section className="flex w-full h-auto sm:p-8 md:p-6 p-4 bg-gradient-to-bl from-blue-600 via-blue-500 to-blue-300 text-white">
      <div className="flex flex-col items-center justify-center w-full sm:p-8 md:p-4 p-4 mb-32 mt-32">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {servicesData.map((service) => (
                ...
                {/* Overlay acinzentado */}
                <div id='IDservicos' className="absolute inset-0 bg-black/60"></div>
